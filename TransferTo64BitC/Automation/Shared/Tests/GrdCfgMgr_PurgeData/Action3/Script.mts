...
' HEADER
'------------------------------------------------------------------'
'    Description:  Data Purge with SPT Numbers
'
...
reporter.ReportNote "ACTION started - Data Purge with SPT Numbers"
...
If SwfWindow("GuardianConfig_PurgeData").SwfButton("btnNext").Exist Then	' page 1
	...
	SwfWindow("GuardianConfig_PurgeData").SwfCheckBox("chkRemoveSPT").Set "ON"
	SwfWindow("GuardianConfig_PurgeData").SwfButton("btnNext").Click
...
reporter.ReportEvent micDone, "Data Purge with SPT Numbers", "ACTION completed"
